...
Most of the source codes of this project, `kanji-recognition` are stored in the `kanji_recognition` directory.
...
`make create-container` creates and launch the kanji_recognition container.
...
access the Jupyter Notebook service in http://localhost:9900.
